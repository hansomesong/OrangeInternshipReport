...
To illustrate our disscusion about VIRTUOSO(installation, execution and assesse), it is better to have an general introduction about
...
and end of the introspection operation. Thus, we could infer that writing a correct training program is not trivial.
...
objective of component "Trace Analyser". This anaylsis 

When a certain trainning program is well invoked, we entre into the 
anaylsis phase. Normally, a training program should be executed multiple time to cover all possible execution path to the most degree.
