...
To remedy this mentioned problem, some VMI applications depending on reutilizing binary code, such as VIRTUOSO, EXTERIOR, HyperShell,etc.,
are presented. As far as I know, VIRTUOSO is the unique open source tool in this domain. Therefore, even though HyperShell has more 
functionalities, we still have to  explore VIRTUOSO to hava a more depper knowledge about reutilization pattern.
