...
\begin{table*}[hbp]
      ...
      \hline
      LibVMI/XenAccess \cite{Reference6} & KVM, Xen & \url{https://code.google.com/p/vmitools} & It uses the paging mechanism of x86 processors from Intel and AMD to perform integrity checks 
      on code pages before execution\\ 
      \hline
      Volatility \cite{Reference36} & KVM,Xen & \url{https://code.google.com/p/volatility}  & It makes use of the paging mechanism and the memory management unit(MMU) 
      in x86 and SPARC hardware architecture to identify running process\\
      \hline
      Insight-VMI \cite{Reference16} & KVM,Xen & \url{https://code.google.com/p/insight-vmi} & Lycosid is capable of detecting and identifying those hidden process on the basis of AntFarm\\
      \hline
      \end{tabular}
\end{table*}